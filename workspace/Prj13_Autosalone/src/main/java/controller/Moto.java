...
@WebServlet("/moto") // Url Mapping --> routes (rotte) --> quando chiamo /moto creo un object di tipo moto quando si fa una richiesta sul sito o sulla web app scrivendo /moto nella barra degli indirizzi
public class Moto extends HttpServlet {

	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
//		System.out.println("Mi hanno chiamato via GET: sono moto");
//		// Click tasto dx sul Java Project
//		// Run as --> Run on Server
//		// http://localhost:8080/autosalone --> per raggiungere l'indirizzo richiesto scrivo /moto
//		
...
//		
//		for (model.Moto veicolo : DB.moto) {
...
//		request.getRequestDispatcher("footer.jsp").include(request, response);
		...
		request.setAttribute("listaVeicoli", DB.moto);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Veicolo v = new model.Moto(marca, modello, prezzo);
