...
@WebServlet("/camper") // Url Mapping --> routes (rotte) --> quando chiamo /camper creo un object di tipo camper quando si fa una richiesta sul sito o sulla web app scrivendo /camper nella barra degli indirizzi
public class Camper extends HttpServlet {

	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
//		System.out.println("Mi hanno chiamato via GET: sono camper");
//		// Click tasto dx sul Java Project
//		// Run as --> Run on Server
//		// http://localhost:8080/autosalone --> per raggiungere l'indirizzo richiesto scrivo /camper
//		
...
//				request.getRequestDispatcher("footer.jsp").include(request, response);
		...
		request.setAttribute("listaVeicoli", DB.camper);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Veicolo v = new model.Camper(marca, modello, prezzo);
